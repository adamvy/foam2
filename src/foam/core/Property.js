...
foam.CLASS({
  ...
  axioms_: [
    ...
    },
    {
      class: 'Property',
      name: 'label',
      documentation: 'If not provided, it defaults to the name "labelized."',
    ...
    },
    {
      class: 'Property',
      name: 'help',
      documenatation: "User-level help. Could/should appear in GUI's as online help."
    },
    {
      class: 'Property',
      name: 'hidden',
      documentation: "Hidden properties to not appear in GUI's by default."
    },
    {
      class: 'Property',
      name: 'value',
...
when accessed for the first time, if not already set. */}
    ...
    },
    {
      ...
      A function of the form:
        ...
        preSet is called before the Property's value has been updated. */}
    },
    {
      class: 'Property',
      name: 'postSet',
    ...
    },
    {
      class: 'Property',
      name: 'cloneProperty',
      documentation: 'Override to provide special deep cloning behaviour.',
      value: function(value, cloneMap) {
    ...
    },
    {
      class: 'Property',
      name: 'required',
      documentation: 'A required Property can not be set to null, undefined, 0 or ""'
    },
    {
      class: 'Property',
      name: 'flags',
    ...
    },
    {
      class: 'Property',
      name: 'f',
      documentation: 'Makes Properties useful as map functions.',
      transient: true,
      factory: function() {
        var name = this.name;
    ...
    },
    {
      class: 'Property',
      name: 'compare',
      documentation: 'Makes Properties useful as comparators.',
      transient: true,
      factory: function() {
    ...
    },
    {
      ...
      code: function installInClass(c, superProp, existingProp) {
        var prop = this;
    ...
    },
    {
      ...
      code: function(proto) {
        ...
        var set = setter ? function(v) { return setter.call(this, v, prop); } :
    ...
    },
    {
      ...
      documentation: 'Validate an object which has this Property.',
      code: function(o) {
    ...
    },
    {
      class: 'Method',
      name: 'toString',
      documentation: 'Returns a developer-readable description of this Property.',
      code: function() { return this.name; }
    },
    {
      class: 'Method',
      name: 'get',
      documentation: 'Flyweight getter for this Property.',
      code: function get(o) { return o[this.name]; }
    },
    {
      class: 'Method',
      name: 'set',
      documentation: 'Flyweight setter for this Property.',
      code: function set(o, value) {
        o[this.name] = value;
        return this;
      }
    },
    ...
    },
    {
      class: 'Method',
      name: 'exportAs',
      code: function exportAs(obj, sourcePath) {
